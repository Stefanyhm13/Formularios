...
coordenadas_dict = crear_diccionario_preguntas(23, 35)
...
def siguiente_opcion():
    ...
    if index < len(opciones):
        ...
        pregunta_actual += 1
        if pregunta_actual > 35:
            pregunta_actual = 23 # Regresar a la primera pregunta si se pasa de la última
...
ruta_imagen = 'C:\\Users\\practicante.rrhh\\Desktop\\cuestio_extralab\\refB.pdf'

# Convertir la segunda página del PDF a imagen
poppler_path = r'C:\Users\practicante.rrhh\Desktop\poppler-24.08.0\Library\bin'
paginas = convert_from_path(ruta_imagen, first_page=3, last_page=3,poppler_path=poppler_path)
