...
def obtener_respuestas_procesadas(respuestas_totales):
    
    if respuestas_totales is None:
        print("respuestas_totales es None en obtener_respuestas_procesadas. Retornando None.")
        return None
...
def funcion_procesar(cuestionarios):

    if len(cuestionarios) <= 1 or cuestionarios[0] is None:
        return None 

    ruta_cuestionario = cuestionarios[0]
